...
class OSCManager {
  ...
  initializeParameterMapping() {
    ...
    const layerParameters = {
      ...
      'AltScale': { setter: 'setAltScale', type: 'number', range: [0.1, 10] },
      'AltStepN': { setter: 'setAltStepN', type: 'number', range: [1, 32] },
      ...
      'ModulusValue': { setter: 'setModulusValue', type: 'number', range: [1, 12] },
